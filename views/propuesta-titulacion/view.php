...
?>
<div class="giiant-crud propuesta-titulacion-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'PropuestaTitulacion'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\PropuestaTitulacion'); ?>
...
[
    ...
    'value' => ($model->propuesta ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'PropuestaTitulacion'=>['propuesta_id' => $model->propuesta_id]])
        : 
 ...
 [
    ...
    'content' => $this->blocks['app\models\PropuestaTitulacion'],
    'active'  => true,
],
 ]
                 ]
