...
?>
<div class="giiant-crud propuesta-centro-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'PropuestaCentro'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\PropuestaCentro'); ?>
...
[
    ...
    'value' => ($model->propuesta ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'PropuestaCentro'=>['propuesta_id' => $model->propuesta_id]])
        : 
 ...
 [
    ...
    'content' => $this->blocks['app\models\PropuestaCentro'],
    'active'  => true,
],
 ]
                 ]
