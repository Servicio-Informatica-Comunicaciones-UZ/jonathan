...
if (\Yii::$app->user->can('app_propuesta-evaluador_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('app_propuesta-evaluador_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('app_propuesta-evaluador_delete', ['route' => true])) {
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('models', 'Propuesta Evaluadors') ?>
        <small>
            List
        </small>
    </h1>
...
<?php
if(\Yii::$app->user->can('app_propuesta-evaluador_create', ['route' => true])){
?>
        <div class="pull-left">
