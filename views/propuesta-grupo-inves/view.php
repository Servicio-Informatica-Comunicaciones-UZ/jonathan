...
?>
<div class="giiant-crud propuesta-grupo-inves-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'PropuestaGrupoInves'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\PropuestaGrupoInves'); ?>
...
[
    ...
    'value' => ($model->propuesta ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'PropuestaGrupoInves'=>['propuesta_id' => $model->propuesta_id]])
        : 
 ...
 [
    ...
    'content' => $this->blocks['app\models\PropuestaGrupoInves'],
    'active'  => true,
],
 ]
                 ]
