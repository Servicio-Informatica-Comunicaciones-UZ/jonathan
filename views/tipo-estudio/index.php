...
$this->title = Yii::t('models', 'Tipo Estudios');
...
?>
<div class="giiant-crud tipo-estudio-index">
...
//         ?>
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                'url' => ['pregunta/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Pregunta'),
            ],
                                [
                'url' => ['propuesta/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Propuesta'),
            ],
